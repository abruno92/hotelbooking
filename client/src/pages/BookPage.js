...
class Rooms extends React.Component {
    ...
    componentDidMount() {
        ...
        this.subscriptions.add(finalizeBooking$.subscribe(async click => await this.handleBook(click)));
        ...
        return (
            <>
                ...
                <section className="single-room">
                    ...
                    {this.isDone$.getValue() ? <h6>Booking Successful</h6> :
                        <Link id="bookingButton" to='/' className="btn-primary"
                              disabled={this.loading$.getValue()}>{this.loading$.getValue() ? "Loading..." : "Finalize Booking"}
                        </Link>
                    }
                </section>
                <Footer/>
